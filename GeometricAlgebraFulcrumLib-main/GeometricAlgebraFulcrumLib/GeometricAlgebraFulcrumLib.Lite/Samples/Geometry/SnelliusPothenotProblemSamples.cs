...
namespace GeometricAlgebraFulcrumLib.Lite.Samples.Geometry
{
    ...
    public static class SnelliusPothenotProblemSamples
    {
        ...
        public static void Example1()
        {
            ...
            data.SolveUsingVGa(out P1x, out P1y, out P2x, out P2y);
            // data.SolveUsingTrig(out P1x, out P1y, out P2x, out P2y);
            // data.SolveUsingComplex(out P1x, out P1y, out P2x, out P2y);
            ...
            double totalTimeVGA = 0, totalTimeTri = 0, totalTimeCom = 0;
            int n = 100;
            ...
            for (int j = 0; j < n; j++)
            {
                ...
                stopwatch.Stop();
                totalTimeTri += stopwatch.Elapsed.TotalMilliseconds;
            }
            ...
            for (int j = 0; j < n; j++)
            {
                ...
                stopwatch.Stop();
                totalTimeCom += stopwatch.Elapsed.TotalMilliseconds;
            }
            ...
            for (int j = 0; j < n; j++)
            {
                ...
                stopwatch.Stop();
                totalTimeVGA += stopwatch.Elapsed.TotalMilliseconds;
            }
            
            Console.WriteLine(data);
            Console.WriteLine($"VGA method result: P1 --> ({P1x}, {P1y})  P2 --> ({P2x}, {P2y})");
        ...
        /*     Console.WriteLine($"CGA Cassini method result: {p2.ToTupleString()}");
            ...
            Console.WriteLine();
            Console.WriteLine($"VGA Mean: {totalTimeVGA/n} ms");
            Console.WriteLine($"Com Mean: {totalTimeCom/n} ms");
            Console.WriteLine($"Tri Mean: {totalTimeTri/n} ms");
        }
