...
using GeometricAlgebraFulcrumLib.Lite.Geometry.Differential.AutoDiff.Compiled;
...
public sealed record SnelliusPothenotData2D
{
    ...
    */
    ...
    public Float64Vector2D SolveUsingVGa1()
    {
        ...
        //var d1 = (v1/Alpha.Sin()).RotateBy(Float64PlanarAngle.Angle90 - Alpha);
        //var d2 = (v2/Beta.Sin()).RotateBy(Beta - Float64PlanarAngle.Angle90);
